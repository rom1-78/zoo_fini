...
$a=$_POST['id'];
 ...
 echo '<input type="text" name="id" value="'.$ligne["id"].'" size="20" ></p>';
  ...
  echo '<input type="text" name="commentaire" size="20" value='.$ligne["commentaire"].'></p><br>';
   ...
   echo '<p><input class="btn btn-outline-success btn-lg" type="submit" name="validation" value="Modifier"></p>';
  echo '<input class="btn btn-outline-success btn-lg" type="reset" name="annuler" value="annuler">';
  echo "</form>";
